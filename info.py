...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "Title 🎬: <code>{file_caption}</code> \n\nᴊᴏɪɴ ɴᴏᴡ: [Movie Storage](https://t.me/moviestorage_official)</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "Title 🎬: <code>{file_caption}</code> \n\nᴊᴏɪɴ ɴᴏᴡ: [Movie Storage](https://t.me/moviestorage_official)</b>")
